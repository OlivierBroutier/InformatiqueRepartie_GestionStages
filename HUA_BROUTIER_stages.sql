...
--
ALTER TABLE `message`
  MODIFY `num_message` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- Contenu de la table `message_etudiant`
--
INSERT INTO `message_etudiant` (`num_message`, `num_etudiant`) VALUES
    (1, 8);
...
--
-- Contenu de la table `message_professeur`
--
INSERT INTO `message_professeur` (`num_message`, `num_prof`) VALUES
    (1, 2);
